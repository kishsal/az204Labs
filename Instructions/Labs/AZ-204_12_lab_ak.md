...
_HINT: you can save time by openning the pre-built solution from the "solutions" folder. If you use the pre-built solution you will still need to download the packages in step 6-8. You will also need to update the code with your Instrumentation Key_ 
